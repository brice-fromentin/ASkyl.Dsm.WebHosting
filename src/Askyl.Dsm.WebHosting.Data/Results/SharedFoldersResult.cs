...
/// <summary>
/// Represents a list of shared folders result from FileStation.
/// </summary>
public sealed class SharedFoldersResult(bool success, string? message, List<FsEntry>? value, ApiErrorCode errorCode = default)
    : ApiResultItems<FsEntry>(success, message, value, errorCode)
{
    [JsonConstructor]
    private SharedFoldersResult() : this(false, null, default!, ApiErrorCode.Failure) { }

    /// <summary>
    /// Creates a successful result with the list of shared folders.
    /// </summary>
    /// <param name="value">The list of shared folder entries.</param>
    /// <param name="message">Optional success message.</param>
    public static SharedFoldersResult CreateSuccess(List<FsEntry> value, string? message = null)
