...
public static partial class ReverseProxyLoggingExtensions
{
    ...
    public static partial void CreatingReverseProxy(this ILogger logger, string siteName);
    ...
    public static partial void FailedToCreateReverseProxy(this ILogger logger, string siteName, int? apiErrorCode);
    ...
    public static partial void ReverseProxyCreationNotVerified(this ILogger logger, string siteName);
    ...
    public static partial void UpdatingReverseProxy(this ILogger logger, string siteName);
    ...
    public static partial void ReverseProxyUpdated(this ILogger logger, string siteName);
    ...
    public static partial void NoReverseProxyToDelete(this ILogger logger, string siteName);
    ...
    public static partial void ReverseProxyAlreadyDeleted(this ILogger logger, string siteName);
