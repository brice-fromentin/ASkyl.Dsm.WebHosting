...
public static partial class DotnetVersionServiceLoggingExtensions
{
    ...
    public static partial void FailedToGetInstalledVersions(this ILogger logger, Exception ex);
    ...
    public static partial void FailedToCheckChannelInstalled(this ILogger logger, Exception ex, string channel);
    ...
    public static partial void FailedToCheckVersionInstalled(this ILogger logger, Exception ex, string version);
    ...
    public static partial void QueryingChannels(this ILogger logger);
    ...
    public static partial void FailedToGetChannels(this ILogger logger, Exception ex);
    ...
    public static partial void QueryingReleases(this ILogger logger, string channel);
    ...
    public static partial void FailedToGetReleases(this ILogger logger, Exception ex, string channel);
}
