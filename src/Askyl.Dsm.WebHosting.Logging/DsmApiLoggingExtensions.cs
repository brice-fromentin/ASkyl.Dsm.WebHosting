...
public static partial class DsmApiLoggingExtensions
{
    ...
    public static partial void ConfigurationFileNotFound(this ILogger logger, string configurationFileName);
    ...
    public static partial void ConfigurationLoaded(this ILogger logger, int count);
    ...
    public static partial void ApiRequest(this ILogger logger, string method, string url, int statusCode, long duration);
    ...
    public static partial void AuthenticationFailed(this ILogger logger, string errorMessage);
    ...
    public static partial void ApiError(this ILogger logger, string errorMessage, int? errorCode);
}
