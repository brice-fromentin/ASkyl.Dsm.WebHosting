...
public static partial class DsmApiLoggingExtensions
{
    ...
    /// </summary>
    [LoggerMessage(EventId = 2000003, Level = LogLevel.Debug, Message = "DSM API request: {Method} {Url} - Status {StatusCode} ({Duration}ms)")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2000004, Level = LogLevel.Warning, Message = "DSM API authentication failed: {ErrorMessage}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2000005, Level = LogLevel.Error, Message = "DSM API error: {ErrorMessage} (Code: {ErrorCode})")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2000006, Level = LogLevel.Debug, Message = "Connecting to DSM API at {Server}:{Port}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2000007, Level = LogLevel.Debug, Message = "Connected to DSM API")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2000008, Level = LogLevel.Debug, Message = "Disconnecting from DSM API")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2000009, Level = LogLevel.Debug, Message = "Disconnected from DSM API")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2000010, Level = LogLevel.Debug, Message = "Starting DSM API handshake")]
