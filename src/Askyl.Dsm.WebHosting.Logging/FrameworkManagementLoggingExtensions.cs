...
public static partial class FrameworkManagementLoggingExtensions
{
    ...
    public static partial void InstallFailedVersionRequired(this ILogger logger);
    ...
    public static partial void FrameworkInstalled(this ILogger logger, string version);
    ...
    public static partial void FrameworkInstallError(this ILogger logger, Exception ex, string version);
    ...
    public static partial void UninstallFailedVersionRequired(this ILogger logger);
    ...
    public static partial void FrameworkUninstalled(this ILogger logger, string version);
    ...
    public static partial void UninstallFailed(this ILogger logger, string message);
    ...
    public static partial void FrameworkUninstallError(this ILogger logger, Exception ex, string version);
}
