...
public static partial class ProcessHandleLoggingExtensions
{
    ...
    /// </summary>
    [LoggerMessage(EventId = 1817, Level = LogLevel.Information, Message = "Sending SIGTERM to process {ProcessId}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1818, Level = LogLevel.Error, Message = "Failed to terminate process {ProcessId}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1819, Level = LogLevel.Information, Message = "Process {ProcessId} exited with code {ExitCode}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1820, Level = LogLevel.Warning, Message = "Process {ProcessId} did not exit within {TimeoutMs}ms")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1821, Level = LogLevel.Warning, Message = "Sending SIGKILL to process {ProcessId}")]
