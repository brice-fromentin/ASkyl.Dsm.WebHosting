...
public static partial class ProcessLoggingExtensions
{
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600005, Level = LogLevel.Information, Message = "Site '{SiteName}' started with PID {ProcessId}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600006, Level = LogLevel.Error, Message = "Failed to start site: {SiteName}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600007, Level = LogLevel.Warning, Message = "Site '{SiteName}' is already stopped (idempotent operation)")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600008, Level = LogLevel.Information, Message = "Site '{SiteName}' stopped successfully")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600009, Level = LogLevel.Warning, Message = "Site '{SiteName}' process no longer exists.")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600010, Level = LogLevel.Error, Message = "Failed to stop site: {SiteName}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600011, Level = LogLevel.Information, Message = "Disposing lifecycle manager for site '{SiteName}'")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600012, Level = LogLevel.Warning, Message = "Force killing process during dispose for site '{SiteName}'")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600013, Level = LogLevel.Error, Message = "Failed to kill process during dispose for site '{SiteName}'")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600014, Level = LogLevel.Warning, Message = "Site '{SiteName}' process was already dead. Cleaning up state.")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600015, Level = LogLevel.Information, Message = "Site '{SiteName}' sent SIGTERM (timeout {Timeout}s)")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600016, Level = LogLevel.Warning, Message = "Site '{SiteName}' did not stop gracefully. Force killing process.")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600017, Level = LogLevel.Error, Message = "Failed to force kill process for site '{SiteName}'. Process may still be running.")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600018, Level = LogLevel.Debug, Message = "Attempting to start site '{SiteName}'")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600019, Level = LogLevel.Debug, Message = "Attempting to stop site '{SiteName}'")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600020, Level = LogLevel.Debug, Message = "Site '{SiteName}' start completed in {Duration}ms")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600021, Level = LogLevel.Debug, Message = "Site '{SiteName}' stop completed in {Duration}ms")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 1600022, Level = LogLevel.Warning, Message = "Site '{SiteName}' process {ProcessId} did not exit within {TimeoutMs}ms")]
