...
public static partial class ArchiveExtractorLoggingExtensions
{
    ...
    /// </summary>
    [LoggerMessage(EventId = 2100001, Level = LogLevel.Debug, Message = "Skipping archive entry: {EntryName}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2100002, Level = LogLevel.Warning, Message = "Archive entry '{EntryName}' attempts to escape target directory. Skipping.")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2100003, Level = LogLevel.Debug, Message = "Successfully extracted archive: {InputFile} to {TargetDirectory}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2100004, Level = LogLevel.Error, Message = "Failed to extract archive. The file may be corrupted or not in valid tar.gz format: {InputFile}")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2100005, Level = LogLevel.Error, Message = "Permission denied when extracting archive to target directory: {TargetDirectory}")]
