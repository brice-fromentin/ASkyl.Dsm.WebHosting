...
public static partial class VersionsDetectorLoggingExtensions
{
    ...
    /// </summary>
    [LoggerMessage(EventId = 2200001, Level = LogLevel.Warning, Message = "dotnet executable not found at {DotnetPath}. Keeping existing cached data.")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2200002, Level = LogLevel.Debug, Message = "Successfully refreshed framework cache with {FrameworkCount} frameworks")]
    ...
    /// </summary>
    [LoggerMessage(EventId = 2200003, Level = LogLevel.Warning, Message = "dotnet --info returned empty output. Keeping existing cached data.")]
