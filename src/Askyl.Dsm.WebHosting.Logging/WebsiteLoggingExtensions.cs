...
public static partial class WebsiteLoggingExtensions
{
    ...
    public static partial void ErrorAddingWebsite(this ILogger logger, Exception ex, string siteName);
    ...
    public static partial void InstanceNotFoundUpdate(this ILogger logger, string siteName);
    ...
    public static partial void ErrorUpdatingWebsite(this ILogger logger, Exception ex, string siteName);
    ...
    public static partial void CannotStartSiteNotFound(this ILogger logger, Guid instanceId);
    ...
    public static partial void LifecycleManagerNotFoundStart(this ILogger logger, Guid siteId);
    ...
    public static partial void CannotStopSiteNotFound(this ILogger logger, Guid instanceId);
    ...
    public static partial void LifecycleManagerNotFoundStop(this ILogger logger, Guid siteId);
    ...
    public static partial void HostingServiceStarting(this ILogger logger);
    ...
    public static partial void HostingServiceStarted(this ILogger logger);

    /// <summary>
    /// Logs stopping of all websites.
    /// </summary>
    [LoggerMessage(EventId = 1513, Level = LogLevel.Information, Message = "Stopping all websites")]
    public static partial void StoppingAllWebsites(this ILogger logger);
    ...
    public static partial void InstanceCreated(this ILogger logger, string siteName);
    ...
    public static partial void AllInstancesInitialized(this ILogger logger, int count);
    ...
    public static partial void SitesFailedToStart(this ILogger logger, int count, string failures);
    ...
    public static partial void InstanceAdded(this ILogger logger, string siteName);
    ...
    public static partial void InstanceNotFoundDuringUpdate(this ILogger logger, string siteName);
    ...
    public static partial void StoppingSiteDisabledOrRestart(this ILogger logger, string siteName);
    ...
    public static partial void InstanceUpdated(this ILogger logger, string siteName);
    ...
    public static partial void CannotRemoveInstanceNotFound(this ILogger logger, Guid instanceId);
    ...
    public static partial void InstanceRemoved(this ILogger logger, string siteName);

    /// <summary>
    /// Logs error during site removal.
    /// </summary>
    [LoggerMessage(EventId = 1525, Level = LogLevel.Error, Message = "Failed to remove site: {SiteName}")]
    public static partial void FailedToRemoveSite(this ILogger logger, Exception ex, string siteName);
    ...
    public static partial void NoApplicationRealPath(this ILogger logger, string siteName);
    ...
    public static partial void SettingHttpGroupPermissions(this ILogger logger, string siteName, string path, bool isDirectory);
    ...
    public static partial void ReverseProxyRuleCreated(this ILogger logger, string siteName);
    ...
    public static partial void FailedToCreateReverseProxyRule(this ILogger logger, Exception ex, string siteName);
    ...
    public static partial void ReverseProxyRuleUpdated(this ILogger logger, string siteName);
    ...
    public static partial void FailedToUpdateReverseProxyRule(this ILogger logger, Exception ex, string siteName);
    ...
    public static partial void ReverseProxyRuleDeleted(this ILogger logger, string siteName);
    ...
    public static partial void FailedToDeleteReverseProxyRule(this ILogger logger, Exception ex, string siteName);
